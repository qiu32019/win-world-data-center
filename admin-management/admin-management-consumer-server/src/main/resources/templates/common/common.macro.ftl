				...
				<ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            欢迎 ${Request["LOGIN_IDENTITY_KEY"].username}
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["LOGIN_IDENTITY_KEY"].role == 1>
                    <li class="nav-click <#if pageName == "jobgroup">active</#if>" ><a href="${request.contextPath}/"><i class="fa fa-circle-o text-red"></i><span>${I18n.jobgroup_name}</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>赢天下</b> ${I18n.admin_version}
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="http://www.yingtianxia.com/" target="_blank" >Scott&Jack</a>
				&nbsp;
                <a href="http://gitlab.bet.com/basic/win-world-data-center.git" target="_blank" >gitlab</a>
